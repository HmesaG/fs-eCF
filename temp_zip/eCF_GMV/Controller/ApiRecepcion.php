...
use FacturaScripts\Core\Base\PublicController;
 ...
 */
class ApiRecepcion extends PublicController
{
    ...
    public function run(): void
    {
        ...
        try {
            ...
            $this->registrarLog($xmlRecibido, $rncEmisor, $encf);
    ...
    private function registrarLog(string $xml, string $rnc, string $encf, string $error = ''): void
    {
        $log = new ECFLog();
